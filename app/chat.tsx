    ...
    setChats((prev) =>
      prev.map((chat) => {
        if (chat.id === currentChatId) {
          ...
          const updatedTitle =
            chat.messages.length === 0 && inputText.trim()
          ...
          setTimeout(() => {
            ...
            setChats((prev2) =>
              prev2.map((chat2) => {
                if (chat2.id === currentChatId) {
                  return {
                    ...chat2,
                    messages: [...chat2.messages, assistantMessage],
                    updatedAt: Date.now(),
                  };
                }
                return chat2;
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Alle Chats</Text>
              <TouchableOpacity
              ...
              {chats.map((chat) => (
                <View key={chat.id} style={styles.chatItemWrapper}>
                  ...
                  >
                    <MessageSquare
                      size={24}
                      color={chat.id === currentChatId ? "#FF9500" : "#666666"}
                      strokeWidth={2}
                    />
                    <View style={styles.chatItemContent}>
                      <Text
                        style={[
                          ...
                          chat.id === currentChatId && styles.chatItemTitleActive,
                        ]}
                        numberOfLines={1}
                      >
                        {chat.title}
